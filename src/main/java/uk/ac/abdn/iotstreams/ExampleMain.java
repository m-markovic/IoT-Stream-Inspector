...
public final class ExampleMain {
    ...
    /**
     * Example: Feed recorded data to an IotStreamsEngine
     */
    ...
    /**
     * Example: Feed (fake) live data to an IotStreamsEngine
     */
    private static void liveDataExample() {
        System.out.println("BEGIN live data example");
        //All data generated by SPARQL updates will be dumped as N3 on System.out
        final IotStreamsEngine engine = IotStreamsEngine.forLiveData(m -> m.write(System.out, "N3"));
        //Add 10 triples, one each second
        for (int i=0; i < 10; i++) {
            engine.accept(parseN3(String.format(
                    "<http://example> <http://value> %d",
                    i)));
            try {
                Thread.sleep(1000);
        ...
        //That's it - but you may have to wait 20-30 seconds before C-SPARQL finishes its business
        engine.log();
        System.out.println("END live data example");
        System.exit(0);
    }
